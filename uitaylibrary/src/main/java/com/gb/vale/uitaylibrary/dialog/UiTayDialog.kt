...
data class UiTayDialogModelCustom(
    ...
    val titleFont: Int = R.font.montserrat_semi_bold,
    val subTitleFont: Int = R.font.montserrat_medium,
    val buttonAcceptFond: Int = R.font.montserrat_semi_bold,
    val buttonCancelFond: Int = R.font.montserrat_semi_bold,
